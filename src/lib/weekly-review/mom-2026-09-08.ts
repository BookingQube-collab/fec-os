...
export const MOM_ACTIONS_2026_09_08: readonly MomActionSeed[] = [
  ...
  // Week 37 brief §09 — Needs your decision (corporate deals)
  row(
    26,
    "26",
    "Corporate deals",
    "BOGO terms — approve monthly redemption cap per aggregator, or move to % discount at next renewal (Urban Point / My Book / Entertainer)",
    "Higher management",
    "This meeting",
    NEEDS,
    "85 free passes MTD; 24% of redemptions but 1.0 ticket each vs 3.7 for staff-ID.",
    SOURCE_CORPORATE_MOM,
  ),
  row(
    27,
    "27",
    "Corporate deals",
    "Seven dormant partners — approve Ops to contact HR/app owners within two weeks (Dar App, Classmate, MyBenefit, DHL, Huawei, QMC, Snoonu)",
    "Operations",
    "Two weeks",
    NEEDS,
    "MyBenefit codes never redeemed since issue.",
    SOURCE_CORPORATE_MOM,
  ),
  row(
    28,
    "28",
    "C&B Vendome",
    "Vendome channel — agree corporate push, or accept site as aggregator acquisition (23 of 24 week redemptions were BOGO)",
    "Higher management",
    "This meeting",
    NEEDS,
    "29 tickets total this week — lowest of four sites.",
    SOURCE_CORPORATE_MOM,
  ),
  row(
    29,
    "29",
    "Corporate deals",
    "Imtyazat vs Al Jazeera Imtiyazat — confirm which ID counters check; merge or separate clearly at till",
    "Operations",
    "This week",
    NEEDS,
    "71 vs 6 month redemptions suggests one code used for both cards.",
    SOURCE_CORPORATE_MOM,
  ),
];
