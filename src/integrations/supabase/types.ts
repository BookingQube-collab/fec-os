...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      attendance_leave_records: { Row: Record<string, unknown> & { id: string; staff_id: string; leave_date: string; leave_type: string; hr_leave_request_id?: string | null }; Insert: Record<string, unknown>; Update: Record<string, unknown>; Relationships: [] }
      ...
      hr_payroll_lines: { Row: Record<string, unknown> & { id: string; period_id: string; staff_id: string; payment_method: string; earnings: unknown; deductions: unknown; gross_qar: number; net_qar: number; wps_eligible: boolean; variance_vs_prev: number | null; proration_factor: number; notes: string | null; employment_category: string | null; position_snapshot: string | null; workplace_snapshot: string | null; working_days: number | null; working_hours: number | null; snapshot: Json; imported_amounts: Json | null; imported_net_qar: number | null; system_net_qar: number | null; variance_import_qar: number | null; review_status: string; line_source: string; override_meta: Json | null; created_at: string; updated_at: string; staff?: { full_name?: string; employee_code?: string; qid?: string | null; location_id?: string | null; department?: string | null; employment_type?: string | null; locations?: { name?: string; code?: string } | { name?: string; code?: string }[] | null } | { full_name?: string; employee_code?: string; qid?: string | null; location_id?: string | null; department?: string | null; employment_type?: string | null; locations?: { name?: string; code?: string } | { name?: string; code?: string }[] | null }[] | null }; Insert: Record<string, unknown>; Update: Record<string, unknown>; Relationships: [{ foreignKeyName: "hr_payroll_lines_period_id_fkey"; columns: ["period_id"]; isOneToOne: false; referencedRelation: "hr_payroll_periods"; referencedColumns: ["id"] }, { foreignKeyName: "hr_payroll_lines_staff_id_fkey"; columns: ["staff_id"]; isOneToOne: false; referencedRelation: "staff"; referencedColumns: ["id"] }] }
      hr_payroll_import_batches: { Row: Record<string, unknown> & { id: string; period_id: string | null; month: string; file_name: string | null; sheet_summary: Json; preview: Json; reconciliation: Json; status: string; committed_at: string | null; committed_by: string | null; created_by: string | null; created_at: string }; Insert: Record<string, unknown>; Update: Record<string, unknown>; Relationships: [{ foreignKeyName: "hr_payroll_import_batches_period_id_fkey"; columns: ["period_id"]; isOneToOne: false; referencedRelation: "hr_payroll_periods"; referencedColumns: ["id"] }] }
      hr_payroll_adjustments: { Row: Record<string, unknown> & { id: string; period_id: string; staff_id: string; line_id: string | null; adj_type: string; amount_qar: number; reason: string | null; document_ref: string | null; status: string; created_by: string | null; approved_by: string | null; approved_at: string | null; created_at: string; updated_at: string }; Insert: Record<string, unknown>; Update: Record<string, unknown>; Relationships: [{ foreignKeyName: "hr_payroll_adjustments_period_id_fkey"; columns: ["period_id"]; isOneToOne: false; referencedRelation: "hr_payroll_periods"; referencedColumns: ["id"] }, { foreignKeyName: "hr_payroll_adjustments_staff_id_fkey"; columns: ["staff_id"]; isOneToOne: false; referencedRelation: "staff"; referencedColumns: ["id"] }, { foreignKeyName: "hr_payroll_adjustments_line_id_fkey"; columns: ["line_id"]; isOneToOne: false; referencedRelation: "hr_payroll_lines"; referencedColumns: ["id"] }] }
      hr_payroll_line_overrides: { Row: Record<string, unknown> & { id: string; line_id: string; field_code: string; original_amount_qar: number; override_amount_qar: number; reason: string; overridden_by: string | null; overridden_at: string }; Insert: Record<string, unknown>; Update: Record<string, unknown>; Relationships: [{ foreignKeyName: "hr_payroll_line_overrides_line_id_fkey"; columns: ["line_id"]; isOneToOne: false; referencedRelation: "hr_payroll_lines"; referencedColumns: ["id"] }] }
      ...
      purchase_requisitions: { Row: Record<string, unknown> & { id: string; pr_number: string | null; requested_at: string; requested_by: string; requester_staff_id: string | null; department_id: string | null; cost_center: string | null; location_id: string; project_name: string | null; event_id: string | null; cost_category_id: string | null; request_type: string; spend_type: string; priority: string; emergency: boolean; required_by: string | null; justification: string; title: string | null; purpose_category: string | null; vendor_id: string | null; estimated_exposure: number | null; payment_structure: string; payment_notes: string | null; status: string; total_amount: number; currency: string; current_step_role: string | null; budget_exception: boolean; over_budget: boolean; excess_amount: number; budget_increase_pending: boolean; price_variance_flag: boolean; hold_reason: string | null; po_id: string | null; submitted_at: string | null; created_at: string; updated_at: string }; Insert: Record<string, unknown>; Update: Record<string, unknown>; Relationships: [] }
      ...
      pr_payment_milestones: { Row: Record<string, unknown> & { id: string; pr_id: string; line_no: number; title: string; amount: number; due_timing: string | null; due_date: string | null; conditions: string | null; status: string; paid_amount: number; cleared_at: string | null; cleared_by: string | null; paid_at: string | null; paid_by: string | null; evidence_note: string | null; created_at: string; updated_at: string }; Insert: Record<string, unknown>; Update: Record<string, unknown>; Relationships: [] }
      ...
      pr_attachments: { Row: Record<string, unknown> & { id: string; pr_id: string; file_name: string; file_path: string; file_mime: string | null; doc_type: string; file_size: number | null; uploaded_by: string | null; created_at: string }; Insert: Record<string, unknown>; Update: Record<string, unknown>; Relationships: [] }
