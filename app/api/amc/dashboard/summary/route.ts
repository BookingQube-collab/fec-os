...
import { fetchAmcDashboardSummary, type AmcDashboardFilters } from "@/lib/queries/amc-dashboard.core";
...
export async function GET(request: Request) {
  return withAuthRouteRequest(
    async (context, req) => fetchAmcDashboardSummary(context, parseFilters(searchParams(req))),
    request,
    { capability: "amc.view" },
  );
}
